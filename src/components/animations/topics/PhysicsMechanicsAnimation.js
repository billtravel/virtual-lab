...
export default function PhysicsMechanicsAnimation({ progress = 30 }) {
  return (
    <div className="relative z-10 w-full h-full flex flex-col items-center justify-center">
      <div className="text-white/20 mb-6 flex flex-col items-center">
        <Atom size={64} className="text-blue-500/30 animate-pulse" />
        <span className="mt-4 font-mono text-sm tracking-widest">[ 机械运动动画 ]</span>
      </div>
      ...
      <div
        className="absolute w-4 h-4 rounded-full shadow-[0_0_15px_currentColor] bg-blue-400 text-blue-400"
        style={{
